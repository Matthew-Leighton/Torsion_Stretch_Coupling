...
def PlotFig1():
	...
	ax1.errorbar(bell_eD_data[0:4],bell_twist_data,yerr = bell_twist_error,xerr = bell_eD_error[0:4],color='tab:green',lw=3,zorder=1,ls='none',fmt='o')
	...
	# Bell Data:
	ax2.errorbar(bell_eTissue_data[0:4],bell_eD_data[0:4]/100 /mean_psi0_squared,yerr = bell_eD_error[0:4]/100 /mean_psi0_squared,xerr = bell_eTissue_error[0:4],color='tab:green',lw=3,zorder=10,ls='none',fmt='o')
	ax2.errorbar(bell_eTissue_data[4],bell_eD_data[4]/100 /mean_psi0_squared,yerr = bell_eD_error[4]/100 /mean_psi0_squared,xerr = bell_eTissue_error[4],color='tab:green',lw=1.5,zorder=10,ls='none',fmt='o')
	...
	ax2.scatter(bell_eTissue_data[0:4]*0.5,bell_eD_data[0:4]/100 /mean_psi0_squared,color='tab:green',facecolors='none',marker='*',zorder=9,s=140)
	ax2.scatter(bell_eTissue_data[4]*0.5,bell_eD_data[4]/100 /mean_psi0_squared,color='tab:green',facecolors='none',marker='*',zorder=9,s=100)
